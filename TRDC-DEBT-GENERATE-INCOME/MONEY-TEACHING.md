...
This money teaching explains the critical difference between good debt and bad debt using Robert Kiyosaki's framework from the Rich Dad philosophy. Good debt is borrowed capital used to acquire income-producing assets where cash flows into your pocket each month. Bad debt is borrowed money used to buy liabilities that drain money from your pocket. The key test is simple: does the debt purchase put money in your pocket or take it out? Understanding this distinction helps you use debt to acquire income-producing assets rather than liabilities.

## When to Follow These Money Teachings

- When deciding whether to take on any form of debt
- When evaluating a potential investment that requires borrowed money
- When someone says "get out of all debt" and you want to understand the nuance
- When considering student loans and weighing career choices
- When determining if a property, vehicle, or other purchase should be financed
- When an opportunity arises to use debt to acquire an income-generating asset
...
- **Problem:** Thinking all debt must be eliminated to be financially safe.
  **Solution:** Eliminate bad debt, but use good debt as a tool to acquire assets. Being debt-free is not the same as being wealthy if you own no income-producing assets.
