...
This chapter teaches that self-defeating "I'm" labels—such as "I'm shy," "I'm not good at math," or "I'm clumsy"—are learned avoidance patterns, not fixed traits, and function as a primary mechanism through which the past can influence your present. It provides a structured process for identifying, challenging, and eliminating these labels by understanding their origins, recognizing the costs they impose, and replacing them with present-moment, choice-based language. Through 19 focused lessons, the chapter gives you the tools to stop treating yourself as a finished product of your history and start being the sum of the choices you make today.

## When to Follow These Book Teachings

- When you catch yourself using self-limiting "I'm" labels—"I'm bad at math," "I'm shy," "I'm not musical"—and accepting them as unchangeable descriptions about yourself
- When you are stuck in patterns you have been unable to break, even though you know they are holding you back from goals you have stated for yourself
- When you want to stop letting childhood messages, old choices, or other people's opinions dictate how you describe yourself now

## Steps

### Step 1: Identify and List Your Self-Descriptors ("I'm" Labels)

Ask yourself: "Who are you?" and "How do you describe yourself?" — write down every label you use, including both positive and negative ones. Compile a complete list of your self-descriptors (I'm nervous, I'm shy, I'm lazy, I'm not musical, I'm clumsy, I'm forgetful). Focus specifically on the negative, self-limiting "I'm" labels — the ones that interfere with your stated goals. Examine whether you want to continue using any of these labels. Decide which labels you are willing to change.

### Step 2: Recognize the Four Neurotic Sentences That Keep You Chained to Your Past

Identify every self-defeating "I'm" you use as rooted in one or more of the following four neurotic sentences:
...
Categorize each of your "I'm" labels into one of two origins:
...
Review the ten categories below and identify which ones apply to you. For each applicable category, name the "neurotic dividend" (payoff) you receive by keeping the label — this is what you avoid by holding onto it. Recognize that each neurotic dividend is a form of avoidance. Decide which labels you want to eliminate.
...
5. **I'm unattractive, ugly, big-boned, plain, too tall** — Neurotic dividend: Keeps you from taking risks in romantic situations and justifies poor self-image and lack of romantic relationships. Gives you a ready-made excuse for not putting yourself forward in a love relationship. "Your perception of yourself is shaped by the labels you have accepted."

6. **I'm unorganized, meticulous, sloppy** — Neurotic dividend: Convenient for manipulating others and justifying why things must be done a certain way. "I've always done it that way." By relying on tradition, you do not have to consider the possibility of doing it differently, and you can ensure everyone else does it your way. This "I'm" relies on the excuse "I've always done it this way" rather than considering whether a different approach might work.
...
Understand the cycle: A thought or belief about yourself (point 1) → leads to a feeling (point 2) → leads to the behavior you expect of yourself (point 3) → which reinforces the original thought (point 4), completing the circle. Recognize that your "I'm" is what you call upon to justify yourself and explain why you persist in behavior that does not serve your stated goals — instead of intervening between points 3 and 4. Challenge any aspect of your life in which you have chosen to be a "finished product." Break the circle by choosing differently at point 3 — act in a way that contradicts the label, rather than confirming it. Reframe your sentence: Change "I'm shy" to "Up until now, I've behaved in a shy manner."
...
Eliminate the word "I'm" wherever you can in reference to your self-defeating labels. Substitute "I'm" sentences with:

- "Until today I've chosen to be that way."
- "I used to label myself…"

Understand that the book describes the idea of fixed human nature as a phrase used to categorize people and create excuses. Your current behavior is shaped by the choices you have made.

### Step 9: Announce Your Commitment to Eliminating "I'm" Labels to Those Close to You

Decide which "I'm" labels you want to eliminate. Announce to those close to you that you are going to work at eliminating these specific "I'm" labels. Ask them to remind you whenever you use an old "I'm" label. Let their reminders serve as an accountability mechanism.
...
Watch out for the four neurotic sentences in your own speech. Whenever you catch yourself using one, correct yourself out loud in the following ways:

- Change **"That's me."** → **"That was me."**
- Change **"I can't help it."** → **"I can change that if I work on it."**
- Change **"I've always been that way."** → **"I'm going to be different."**
- Change **"That's my nature."** → **"That's what I used to believe was my nature."**

Say the corrected version aloud each time you catch yourself.

### Step 14: Work on Eliminating One "I'm" Per Day

Select one "I'm" label to eliminate for just that single day. Devote the day to working at being aware of this tendency. Actively alter a behavior associated with that "I'm" on that day. Repeat with a different "I'm" the following day, working on them one at a time until each is eliminated.
...
### Step 18: Adopt the "I'm an 'I'm' Exorcist" Identity

If you must keep an "I'm" label, choose this one: "I'm an 'I'm' exorcist — and I like it." Make identifying and eliminating erroneous "I'm" labels a conscious part of your identity. Treat every limiting "I'm" as a belief to be examined and changed. Embrace the identity of someone who actively identifies and changes their own self-imposed limitations.
...
### Example 1: The "I'm" List — Sample Self-Descriptors

The book provides a sample list of "I'm" labels: "I'm Fat, I'm a Lousy Cook, I'm Shy, Not Musical, a Poor Speller, Lazy, Not Athletic, Tired Easily, Timid, Sloppy, Sickly, Afraid, Stubborn, Gauche, Clumsy, Immature, Accident Prone, Anxious, Meticulous, Short Fused, Forgetful, Careless, Hostile, Not Mechanical, Vindictive, Solemn, Poor at Mathematics, Irresponsible, Apathetic, A Loner, Nervous, Bored, Frigid."
...
- ✅ Identify and write down every "I'm" label you use, especially the negative ones
- ✅ Categorize each label by its origin—from others or from self-created avoidance
- ✅ Name the specific neurotic dividend you receive from each label you want to eliminate
- ✅ Break the "I'm circle" by choosing to act differently at point 3, even before the feeling changes
- ✅ Reframe 'I'm' labels using past-tense, choice-based language: "Up until now, I've behaved in a shy manner"
- ✅ Eliminate the word "I'm" from your self-description wherever possible
- ✅ Work on eliminating one "I'm" label per day, focusing on small, specific behavioral changes
- ✅ Enlist a trusted confidant to signal you silently when you fall back into an old "I'm"
- ✅ Keep a journal of "I'm" behavior and work at reducing the entries over time
- ✅ Correct the four neurotic sentences out loud each time you catch yourself using them
- ✅ Announce your commitment to people close to you so they can serve as accountability partners
- ✅ Try something new that you have avoided to challenge and potentially discard an "I'm" label
- ❌ Don't accept "I'm" labels as fixed or permanent traits
- ❌ Don't blame others for the labels you carry—you chose to accept and keep them
- ❌ Don't use the four neurotic sentences ("That's me," "I've always been that way," "I can't help it," "That's my nature") as justification for staying the same
- ❌ Don't allow the "I'm" to complete the circle—intervene between the feeling and the behavior
- ❌ Don't use ethnic, age-related, or personality "I'm" labels as excuses for behavior you want to change
...
- **Problem:** You accept "I'm" labels as descriptions that cannot change about yourself—"I'm bad at math," "I'm shy," "I'm not athletic"—and don't question their origins.
  **Solution:** Categorize each label by its origin. Labels from others are beliefs you accepted during childhood without examining them. Self-created labels are adaptive but inaccurate excuses. In both cases, you are saying "I am a finished product." You are not. Ask: "Who decided this?" and realize it was a choice, not an established truth.

- **Problem:** You use the four neurotic sentences ("That's me," "I've always been that way," "I can't help it," "That's my nature") to justify staying the same, and believe you cannot change.
  **Solution:** Correct each sentence out loud the moment you catch it: "That's me" → "That was me"; "I've always been that way" → "I'm going to be different"; "I can't help it" → "I can change that if I work on it"; "That's my nature" → "That's what I used to believe was my nature." Each correction is a statement that you are choosing differently today.

- **Problem:** You blame others (parents, teachers, culture) for your present-day "I'm" labels, which gives them influence over your life and provides a justification for not changing.
  **Solution:** Accept full responsibility: Every "I'm" you have chosen to keep could be relabeled, "I've chosen to be." Blaming others grants them authority over you and creates a reason to avoid risk-taking. It is difficult to change something you do not acknowledge.

- **Problem:** You are stuck in a self-defeating pattern and do not know how to break the cycle—the thought produces the feeling, which produces the behavior, which reinforces the thought.
  **Solution:** Interrupt the "I'm circle" between point 3 (behavior impulse) and point 4 (reinforcing completion). At that moment, choose to act in a way that contradicts the label. Set a specific behavioral goal that forces you to act differently. One new action is enough to create evidence that contradicts the label.
